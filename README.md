...
This license allows for free **non-commercial** use for **academic, non-profit and U.S. government institutions**. Modification should be fed back to the original repository to benefit all users. If interested in a non-commercial license of this type, please email azournas@lbl.gov using the email address from your qualifying institution (e.g. .edu or .gov), and provide your github handle. You will then be added to the private github repository containing the `ART` source code.
